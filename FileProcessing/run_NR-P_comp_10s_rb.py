...
def run_NR_P_comp_10s_RiverBed():
	log_file = open("Logs/NR-P_comp_10s_rb.txt", "w")
	log_file.write(t() + " > Starting NR-P metrics of River Bed compressed videos...")
	results_file = open("../resources/LiveVD/Scores/NR-P_comp_10s_rb_scores.txt", "w")
	log_file.write(t() + " > Opened results file...")
	for video in LiveVD_dis_cat("rb"):
		try:
	...
	results_file.close()
	log_file.write(t() + " > Done. Results can be found in ../resources/LiveVD/Scores/NR-P_comp_10s_rb_scores.txt")

run_NR_P_comp_10s_RiverBed()