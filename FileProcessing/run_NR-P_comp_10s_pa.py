...
def run_NR_P_comp_10s_PedestrianArea():
	log_file = open("Logs/NR-P_comp_10s_pa.txt", "w")
	log_file.write(t() + " > Starting NR-P metrics of Pedestrian Area videos...")
	results_file = open("../resources/LiveVD/Scores/NR-P_comp_10s_pa_scores.txt", "w")
	log_file.write(t() + " > Opened results file...")
	for video in LiveVD_dis_cat("pa"):
		try:
