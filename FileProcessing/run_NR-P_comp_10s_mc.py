...
def run_NR_P_comp_10s_MobileCalendar():
	log_file = open("Logs/NR-P_comp_10s_mc.txt", "w")
	log_file.write(t() + " > Starting NR-P metrics of Mobile Calendar compressed videos..." + "\n")
	results_file = open("../resources/LiveVD/Scores/NR-P_comp_10s_mc_scores.txt", "w")
	log_file.write(t() + " > Opened results file..." + "\n")
	for video in LiveVD_dis_cat("mc"):
		try:
	...
	results_file.close()
	log_file.write(t() + " > Done. Results can be found in ../resources/LiveVD/Scores/NR-P_comp_10s_mc_scores.txt" + "\n")

run_NR_P_comp_10s_MobileCalendar()