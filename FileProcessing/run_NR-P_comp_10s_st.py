...
def run_NR_P_comp_10s_Station():
	log_file = open("Logs/NR-P_comp_10s_st.txt", "w")
	log_file.write(t() + " > Starting NR-P metrics of Station compressed videos..." + "\n")
	results_file = open("../resources/LiveVD/Scores/NR-P_comp_10s_st_scores.txt", "w")
	log_file.write(t() + " > Opened results file..." + "\n")
	for video in LiveVD_dis_cat("st"):
		try:
